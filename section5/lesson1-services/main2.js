...
//	$scope.selectedPerson = ContactService.selectedPerson;
	var vmDetail = this;
	vmDetail.contactSvc = ContactService;	
});
...
app.controller('PersonListController', function ($scope, ContactService) {
	...
	vmList.search = "";
	vmList.order = "email";
//	vmList.persons = ContactService.persons;
//	vmList.selectedPerson = ContactService.selectedPerson;
	vmList.contactSvc = ContactService;

//	$scope.selectPerson = function (person, index) {
//		$scope.selectedPerson = ContactService.selectedPerson = person;
//	};

	$scope.sensitiveSearch = function(person) {
		if (vmList.search) {
			return person.name.indexOf(vmList.search) == 0 ||
				     person.email.indexOf(vmList.search) == 0;
		}
		return true;
	};
